<template>
          ...
          <div class="btns">
            <RouterLink to="signin">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="64" height="64">
                <path d="M16 4C9.382813 4 4 9.382813 4 16C4 22.617188 9.382813 28 16 28C20.050781 28 23.640625 25.988281 25.8125 22.90625L24.1875 21.75C22.378906 24.320313 19.390625 26 16 26C10.464844 26 6 21.535156 6 16C6 10.464844 10.464844 6 16 6C19.390625 6 22.375 7.679688 24.1875 10.25L25.8125 9.09375C23.640625 6.011719 20.050781 4 16 4 Z M 23.34375 11.28125L21.90625 12.71875L24.1875 15L12 15L12 17L24.1875 17L21.90625 19.28125L23.34375 20.71875L27.34375 16.71875L28.03125 16L27.34375 15.28125Z" />
              </svg>
              <p>Sign Out</p>
            </button>
            </RouterLink>
            <RouterLink to="terms">
              ...
              <path d="M24 4C12.972066 4 4 12.972074 4 24C4 35.027926 12.972066 44 24 44C35.027934 44 44 35.027926 44 24C44 12.972074 35.027934 4 24 4 z M 24 7C33.406615 7 41 14.593391 41 24C41 33.406609 33.406615 41 24 41C14.593385 41 7 33.406609 7 24C7 14.593391 14.593385 7 24 7 z M 23.976562 13.978516 A 1.50015 1.50015 0 0 0 22.5 15.5L22.5 22.5L15.5 22.5 A 1.50015 1.50015 0 1 0 15.5 25.5L22.5 25.5L22.5 32.5 A 1.50015 1.50015 0 1 0 25.5 32.5L25.5 25.5L32.5 25.5 A 1.50015 1.50015 0 1 0 32.5 22.5L25.5 22.5L25.5 15.5 A 1.50015 1.50015 0 0 0 23.976562 13.978516 z" />
              </svg>
  ...
  <div class="contactus">
    ...
    <div class="container">
      ...
      <div class="right">
        <img src="../assets/shake-hands.jpg" alt="">
      </div>
    </div>
  </div>
  <div class="footer">
      ...
      <div class="links">
        <a href="https://instagram.com">
          ...
          <g>
            <path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M30,11H18c-3.9,0-7,3.1-7,7v12c0,3.9,3.1,7,7,7h12c3.9,0,7-3.1,7-7V18C37,14.1,33.9,11,30,11z" />
            <circle cx="31" cy="16" r="1" fill="#fff" />
          </g>
          <g>
            <circle cx="24" cy="24" r="6" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
          </g>
        </svg>
        </a>
        ...
        <a href="tel:+0791013879" >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="96" height="96">
            <path fill="#009688" d="M5.995,8.853l0.038,3.744c0.135,13.188,17.049,28.249,28.365,28.365L38.143,41 c1.034,0.01,1.863-0.819,1.853-1.853l-0.077-7.488c-0.011-1.034-0.857-1.88-1.891-1.891L29.871,29.6l-4.01,4.706 c-2.642-0.027-13.145-10.531-13.172-13.172l4.706-4.284l-0.168-7.882c-0.011-1.034-0.857-1.88-1.891-1.891L7.848,7 C6.814,6.99,5.985,7.819,5.995,8.853z" />
            <path fill="#dd2c00" d="M40,17.625C40,12.313,33,7,33,7c0,4.25-6,6.375-6,10.625C27,21.145,29.911,24,33.5,24 S40,21.146,40,17.625z" />
            <path fill="#ff5722" d="M30,18.625C30,16,34,15.25,34,13c0,0,3,2.25,3,5.625C37,20.489,35.433,22,33.5,22 S30,20.489,30,18.625z" />
            <path fill="#ffc107" d="M32,20.5c0-1.167,1.714-1.5,1.714-2.5c0,0,1.286,1,1.286,2.5c0,0.828-0.672,1.5-1.5,1.5 S32,21.329,32,20.5z" />
          </svg>
        </a>
      </div>
  </div>
